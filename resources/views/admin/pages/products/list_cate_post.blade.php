...
<div id="content" class="fl-right">
    <div class="section" id="title-page">
        <div class="clearfix">
            ...
            <a href="{{route('create.cate.post')}}" title="" id="add-new" class="fl-left">Thêm Danh Mục Mới</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="clearfix">
                                ...
                                <ul class="list-operation fl-right">
                                    ...
                                    <li><a href="{{route('delete.cate.post',$cate->id)}}"onclick="return confirm('bạn muốn xóa danh mục bài viết này?')" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                </ul>
                            </td>
                            @foreach($users as $user)
                            @if($cate->user_id == $user->id)
