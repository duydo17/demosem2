            ...
            <div class="section" id="list-blog-wp">
                ...
                <div class="section-detail">
                    <form action="{{route('change_password.user', $id )}}" method="Post">
                        @csrf
                        <label for="password_old"><b>Mật Khẩu Cũ</b></label>
                        <input type="password" class="input_text" placeholder="Nhập Mật Khẩu Cũ" name="password_old">
                        @error('password_old')
                ...
                <div class="secion-detail">
                    <ul class="list-item">
                        ...
                        <li style="border-bottom: 1px solid #eee;">
                            <a href="{{route('info_account',$id)}}" style="font-size: 18px; color: #333; " title="">Thông Tin Tài Khoản</a>
                        </li>
                        <li style="border-bottom: 1px solid #eee;">
